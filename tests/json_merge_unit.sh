...
test_merge_component_null_settings_key_applies_managed_paths() {
  ...
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_merge_component_settings agents "$target" >/dev/null 2>&1
  ...
  expected_model="$(jq -r '.model' "$ARSENAL_ROOT/shared/settings.shared.json")"
...
test_merge_component_hook_idempotent() {
  ...
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_merge_component_settings branch-guard "$target" "--target-dir=$tmp" >/dev/null 2>&1
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_merge_component_settings branch-guard "$target" "--target-dir=$tmp" >/dev/null 2>&1
...
test_merge_component_target_dir_substitution() {
  ...
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_merge_component_settings branch-guard "$target" "--target-dir=/test/sentinel" >/dev/null 2>&1
...
test_unmerge_component_hook_idempotent() {
  ...
  # First unmerge
  local result1=0
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_unmerge_component_settings branch-guard "$target" >/dev/null 2>&1 || result1=$?
  ...
  local result2=0
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_unmerge_component_settings branch-guard "$target" >/dev/null 2>&1 || result2=$?
...
test_merge_component_target_dir_real_data_substitution() {
  ...
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_merge_component_settings branch-guard "$target" "--target-dir=/tmp/test-home/.claude" >/dev/null 2>&1
...
test_merge_component_session_start_hook_idempotent() {
  ...
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_merge_component_settings session-start "$target" "--target-dir=$tmp" >/dev/null 2>&1
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_merge_component_settings session-start "$target" "--target-dir=$tmp" >/dev/null 2>&1
...
test_merge_component_session_start_target_dir_substitution() {
  ...
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_merge_component_settings session-start "$target" "--target-dir=/test/sentinel" >/dev/null 2>&1
...
test_unmerge_component_session_start_hook_idempotent() {
  ...
  # First unmerge
  local result1=0
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_unmerge_component_settings session-start "$target" >/dev/null 2>&1 || result1=$?
  ...
  # Second unmerge (idempotent)
  local result2=0
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_unmerge_component_settings session-start "$target" >/dev/null 2>&1 || result2=$?
...
test_unmerge_component_no_parent_on_empty() {
  ...
  local result=0
  ARSENAL_ROOT="$ARSENAL_ROOT" forge_unmerge_component_settings statusline "$target" >/dev/null 2>&1 || result=$?
