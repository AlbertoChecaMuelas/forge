---
description: "Ad-hoc post-change audit: fills the arsenal review template and dispatches a fresh review subagent (model opus) over a commit range, branch vs base, or the working tree. Use when the user says 'review', 'audit', 'before merging', 'security review' or asks to assess an existing change."
